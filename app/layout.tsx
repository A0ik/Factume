    ...
    '@graph': [
      {
        ...
        name: 'Factu.me',
        alternateName: ['Factu.me', 'facturme', 'factume', 'factu me', 'Factume'],
      ...
      },
      {
        ...
        offers: [
          ...
          },
          {
            ...
            description: 'Factures illimitées, dictée vocale IA, signature eIDAS gratuite',
            availability: 'https://schema.org/InStock',
          },
          {
            '@type': 'Offer',
            ...
            description: 'Contrats CDI/CDD, CRM, Factur-X conforme 2026, export FEC comptable',
            availability: 'https://schema.org/InStock',
          },
          {
            '@type': 'Offer',
            ...
            description: 'OCR IA, API, multi-workspaces, connexion PDP, support prioritaire',
            availability: 'https://schema.org/InStock',
          },
        ],
