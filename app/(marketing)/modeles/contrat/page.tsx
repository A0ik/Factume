...
export default function ModeleContratPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-6xl font-black text-gray-900 tracking-tight mb-6">
              ...
              <span className="text-amber-600">CDI & CDD Conformes</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/register"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-amber-600 to-orange-600 rounded-2xl hover:from-amber-700 hover:to-orange-700 transition-all shadow-xl"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {contractTypes.map((type, i) => (
              <div key={i} className="p-8 rounded-3xl bg-gradient-to-br from-gray-50 to-white border border-gray-100 hover:border-amber-200 hover:shadow-lg transition-all">
                <h3 className="text-xl font-bold text-gray-900 mb-3">{type.title}</h3>
                <p className="text-gray-600 mb-4">{type.description}</p>
                <div className="flex flex-wrap gap-2">
                  {type.tags.map((tag, j) => (
                    <span key={j} className="px-3 py-1 bg-amber-50 text-amber-600 rounded-full text-xs font-semibold">
                      {tag}
                    </span>
                  ))}
                </div>
            ...
            {faqItems.map((faq, i) => (
              <details key={i} className="group bg-white rounded-2xl border border-gray-100">
                <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                  ...
                  <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center text-amber-600 group-open:rotate-45 transition-transform text-xl font-light">+</span>
                </summary>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <Link key={i} href={link.href} className="group p-6 rounded-2xl bg-gray-50 border border-gray-100 hover:border-amber-200 transition-all">
                <h3 className="font-bold text-gray-900 mb-2 group-hover:text-amber-600 transition-colors">{link.title}</h3>
                <p className="text-sm text-gray-600">{link.desc}</p>
                <span className="inline-flex items-center text-sm text-amber-600 mt-2 font-medium">
      ...
      {/* CTA */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-amber-600 to-orange-600">
