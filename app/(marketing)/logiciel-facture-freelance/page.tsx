...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'créer facture freelance',
    'facture freelance en ligne',
    'modèle facture freelance',
    'facture freelance gratuit',
    'générer facture freelance',
    'facture consultant independant',
    'logiciel facture consultant',
    'facture freelance rapide',
    'facture freelance international',
    'outil facture freelance',
    'facture freelance auto-entrepreneur',
  ],
  openGraph: {
    title: 'Logiciel de Facture Freelance – Créez Vos Factures en 30 Secondes',
