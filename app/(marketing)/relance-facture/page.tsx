        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-6xl font-black text-gray-900 tracking-tight mb-6">
              Relance de Facture – <span className="text-emerald-600">Automatisez Vos Relances d\'Impayés</span>
            </h1>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { day: 'J+7', title: 'Rappel amical', desc: 'Email courtois rappelant l\'échéance dépassée.', color: 'border-emerald-200 bg-emerald-50' },
              { day: 'J+14', title: 'Relance ferme', desc: 'Email plus direct avec demande de règlement immédiat.', color: 'border-emerald-200 bg-emerald-50' },
              ...
              <div key={i} className={`rounded-2xl p-6 border ${step.color} text-center`}>
                <p className="text-sm font-bold text-emerald-600 mb-2">{step.day}</p>
