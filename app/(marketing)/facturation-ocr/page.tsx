...
export const metadata: Metadata = {
  ...
  keywords: [
    'ocr facturation',
    'ocr recus',
    'numérisation factures ia',
    'scanner tickets frais',
    'extraction automatique facture',
    'ocr notes de frais',
    'numériser reçus smartphone',
    'ocr facture automatique',
    'categorisation depenses ia',
    'export fiscal factures',
    'reconnaissance caractere facture',
...
export default function OcrFacturationPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-6xl font-black text-gray-900 tracking-tight mb-6">
              OCR Facturation – Numérisez Vos Reçus avec <span className="text-cyan-600">l&apos;IA</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/register"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-cyan-600 to-cyan-700 rounded-2xl hover:from-cyan-700 hover:to-cyan-800 transition-all shadow-xl hover:shadow-2xl"
              >
              ...
              <Link
                href="/demo"
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-gray-700 bg-white border-2 border-gray-200 rounded-2xl hover:border-cyan-300 transition-all"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, i) => (
              <div key={i} className="flex gap-4 p-6 rounded-2xl bg-gradient-to-br from-gray-50 to-white border border-gray-100 hover:border-cyan-200 transition-all">
                <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-600 flex items-center justify-center text-white">
      ...
      {/* CTA */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-cyan-600 to-cyan-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/register"
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-cyan-700 bg-white rounded-2xl hover:bg-gray-50 transition-all shadow-xl"
          >
