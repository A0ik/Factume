...
export const metadata: Metadata = {
  ...
  keywords: [
    'facturation vocale',
    'facture par la voix',
    'dictée vocale facture',
    'reconnaissance vocale facturation',
    'transcription IA facture',
    'facture vocale auto-entrepreneur',
    'logiciel facturation vocale',
    'créer facture par voix',
    'facturation intelligente',
    'assistant vocal facture',
    'facture dictée automatique',
    'speech to text facture',
  ],
  openGraph: {
