    ...
    <div className="max-w-4xl mx-auto space-y-5 pb-8 lg:pb-8 pb-28">
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={() => router.push('/documents/factures')}
        ...
        <div className="flex-1">
          <h1 className="text-xl sm:text-2xl font-black text-gray-900 dark:text-white">Nouvelle facture</h1>
          <p className="text-xs sm:text-sm text-gray-400 dark:text-gray-500 mt-0.5">Remplissez les informations ci-dessous pour créer votre facture.</p>
        </div>
      </motion.div>
        ...
        {mode === 'ai' && (
          ...
          >
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 sm:py-3.5 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white text-sm font-bold transition-all disabled:opacity-40 shadow-lg shadow-blue-500/20"
            >
              {aiLoading ? (
                <>
                    ...
                    {showSuggestions && suggestions.length > 0 && (
                      ...
                      >
                        {suggestions.slice(0, 5).map((c) => (
                          ...
                          >
                            <div className="w-7 h-7 rounded-lg bg-blue-500/10 dark:bg-blue-500/20 flex items-center justify-center text-blue-500 text-xs font-bold flex-shrink-0">
                    ...
                    >
                      ...
                      <div className="flex gap-2 mb-2">
                        ...
                        <motion.button
                          ...
                          className="flex items-center gap-1.5 px-3 py-2 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white rounded-xl text-xs font-semibold shadow-md hover:shadow-lg transition-all whitespace-nowrap"
                ...
                <div className="p-4">
                  ...
                  {profile?.payment_terms && !notes && (
                    <motion.button
                      ...
                      className="mt-2 text-xs text-blue-600 font-semibold hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 hover:underline transition-colors"
                    >
              ...
              <div className="lg:sticky lg:top-6 space-y-3">
                ...
                >
                  ...
                  <div className="px-5 py-4 space-y-2.5">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-blue-400 font-black text-lg sm:text-xl tabular-nums">{formatCurrency(total)}</span>
                    </div>
                  </div>
                ...
                >
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-semibold text-gray-700 dark:text-gray-300">Facture</span>
                  </div>
                  <div className="flex justify-between text-xs">
                ...
                <motion.button
                  ...
                  onClick={handleSave}
                  disabled={saving}
                  className={`w-full flex items-center justify-center gap-2 py-3.5 sm:py-4 rounded-2xl text-sm font-bold transition-all shadow-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:from-blue-600 hover:to-indigo-600 shadow-blue-500/30 hover:shadow-blue-500/40 ${saving ? 'cursor-not-allowed opacity-70' : ''}`}
                >
                  {saving ? (
                    <>
                      <Loader2 size={16} className="animate-spin" />
              ...
              <div className="p-4 border-b border-gray-200 dark:border-white/10">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  />
                </div>
              </div>
                  ...
                  <div className="text-center py-12">
                    ...
                    {!productSearch && (
                      <button
                        ...
                        className="mt-4 px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-xl text-sm font-semibold hover:shadow-lg transition-all"
                      >
                        Créer des produits
                      </button>
                    )}
                  ...
                  <div className="space-y-2">
                    {filteredProducts.map((product) => (
                      <motion.button
                        ...
                        className="w-full p-4 bg-gray-50 dark:bg-white/5 hover:bg-blue-50 dark:hover:bg-blue-500/10 border border-gray-200 dark:border-white/10 hover:border-blue-200 dark:hover:border-blue-500/30 rounded-2xl transition-all text-left group"
                      >
