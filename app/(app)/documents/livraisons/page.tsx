  ...
  return (
    <div className="p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Bons de livraison</h1>
...
function EmptyState({ inline }: { inline?: boolean }) {
  return (
    <div className={inline ? 'py-8' : 'flex flex-col items-center justify-center py-20'}>
      ...
      <p className="text-xs text-gray-400 mb-4">Créez votre premier bon de livraison pour commencer</p>
      <Link
        href="/documents/livraisons/new"
