        ...
        {mode === 'voice' && (
          ...
          >
            {!sub.canUseVoice && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-600 dark:text-amber-500/80 mt-0.5">Dicttez vos acomptes à voix haute, l'IA les remplit automatiquement</p>
                </div>
              </motion.button>
            )}
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="relative">
                ...
                <motion.button
                  ...
                  disabled={loading}
                  className={`relative w-24 sm:w-28 h-24 sm:h-28 rounded-full flex items-center justify-center transition-all duration-200 shadow-xl ${recording ? 'bg-gradient-to-br from-red-500 to-red-600 hover:from-red-600 hover:to-red-700' : 'bg-gradient-to-br from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600'} ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                  {loading ? (
              ...
              <div className="space-y-1 text-center">
                ...
                {!recording && !loading && (
                  <p className="text-xs text-gray-300 dark:text-gray-600">
                    Ex: "Facture d'acompte pour Entreprise XYZ, design web 5 jours à 2000€, TVA 20%"
                  </p>
                )}
              </div>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => setMode('manual')}
              className="text-sm text-emerald-600 font-semibold hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300 transition-colors"
            >
